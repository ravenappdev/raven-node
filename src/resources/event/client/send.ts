...
export interface Request {
  ...
  _body: RavenApi.SendEventRequest;
}

export type Response = core.APIResponse<RavenApi.SendEventResponse, RavenApi.event.send.Error>;
export type Error = RavenApi.event.send.Error._Unknown;
...
export declare namespace Error {
  ...
  interface _Utils {
    _visit: <_Result>(visitor: RavenApi.event.send.Error._Visitor<_Result>) => _Result;
  }
