...
export const Device: core.schemas.ObjectSchema<Device.Raw, RavenApi.device.Device> = core.schemas.object({
  ...
  platform: core.schemas.lazy(() => serializers.device.Platform).optional(),
  ...
  deviceSid: core.schemas.property("device_sid", core.schemas.lazy(() => serializers.ids.DeviceId).optional()),
...
export declare namespace Device {
  interface Raw {
    id?: string | null;
    platform?: serializers.device.Platform.Raw | null;
    ...
    device_sid?: serializers.ids.DeviceId.Raw | null;
