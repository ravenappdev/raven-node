...
export const Device: core.schemas.ObjectSchema<Device.Raw, RavenApi.Device> = core.schemas.object({
  id: core.schemas.string().optional(),
  platform: core.schemas.lazy(async () => (await import("../..")).Platform).optional(),
  ...
  deviceSid: core.schemas.property(
    "device_sid",
    core.schemas.lazy(async () => (await import("../..")).DeviceId).optional()
  ),
